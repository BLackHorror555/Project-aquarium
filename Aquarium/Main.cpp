...
void main()
{
	...
	Controller controller(15, 25, 15, 2, WIDTH, HEIGHT);
	...
	//установка параметров системы
	{
		...
		controller.SetHungerLifetime(449, 500);
		controller.SetLifeTime(325, 600, 1000);
		controller.SetMoveRange(30, 30, 25);
		controller.SetReproductionPeriod(160, 330, 501);
		controller.SetSpeed(0.05, 0.07, 0.1);
