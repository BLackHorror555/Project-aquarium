...
void main()
{
	...
	Controller controller(8, 40, 25, 5, WIDTH, HEIGHT);
	...
	//установка параметров системы
	{
		...
		controller.SetLifeTime(99, 159, 199);
		controller.SetMoveRange(20, 17, 20);
		controller.SetReproductionPeriod(35, 80, 80);
